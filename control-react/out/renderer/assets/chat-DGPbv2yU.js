import { b as commonjsGlobal, g as getDefaultExportFromCjs, j as jsxRuntimeExports, r as reactExports, m as motion, A as AnimatePresence, c as client, R as React } from "./globals-DPKk9YB3.js";
import { c as create$1, d as devtools, p as persist, i as immer } from "./immer-zSCVQdSb.js";
  ...
  devtools(
    persist(
      immer((set) => ({
        ...
        finalizeStream: (sessionId, messageId) => set((state) => {
          if (!state.messages[sessionId]) state.messages[sessionId] = [];
        ...
        addActionStep: (step) => set((state) => {
          state.currentActions.push(step);
        }),
        updateActionStep: (index2, update) => set((state) => {
          if (state.currentActions[index2]) {
            Object.assign(state.currentActions[index2], update);
          }
        }),
...
const useTaskExecution = () => {
  ...
  const executeTask = reactExports.useCallback(async (text2, mode = "act", attachments = []) => {
    ...
    try {
      const payload = { text: text2, mode, attachments };
      await window.chatAPI.executeTask(payload, mode);
    } catch (error2) {
      console.error("Task execution failed:", error2);
      setProcessing(false);
    }
  }, [activeSessionId, addMessage, setProcessing, setMode, clearActions]);
  const stopTask = reactExports.useCallback(async () => {
  ...
  reactExports.useEffect(() => {
    ...
    const unsubActionComplete = window.chatAPI.onActionComplete((_, data) => {
      updateActionStep(0, { status: "completed" });
    });
    ...
    const unsubError = window.chatAPI.onBackendError((_, error2) => {
      console.error("Backend error:", error2);
      setProcessing(false);
    });
    return () => {
      unsubStream();
...
const useVoice = () => {
  ...
  const [isWakewordEnabled, setIsWakewordEnabled] = reactExports.useState(true);
  const speak = reactExports.useCallback(async (text2) => {
    await window.chatAPI.speakGreeting(text2);
  }, []);
  const stopSpeaking = reactExports.useCallback(async () => {
    await window.chatAPI.stopAudio();
  }, []);
  const toggleWakeword = reactExports.useCallback(async (enabled) => {
...
const useVosk = (onResult) => {
  ...
  const startRecording = reactExports.useCallback(async () => {
    ...
    try {
      ...
      const source2 = audioContext.createMediaStreamSource(stream);
...
const CodeBlock = ({ code: code2, language: language2 = "text" }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative my-4 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-subtle)] overflow-hidden group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-2 bg-black/20 border-b border-[var(--border-subtle)]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-[var(--text-muted)]", children: language2 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: handleCopy,
          className: "p-1 rounded hover:bg-white/10 text-[var(--text-muted)] hover:text-white transition-colors",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: copied ? "Check" : "Copy", size: "sm" })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "p-4 overflow-x-auto font-mono text-sm leading-relaxed text-[var(--text-primary)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: code2 }) })
  ] });
};
const SlashCommandPopup = ({
  ...
  const getIconForCommand = (cmd) => {
    const c2 = cmd.toLowerCase();
    if (c2.includes("web")) return "Globe";
    if (c2.includes("cmd") || c2.includes("terminal")) return "Terminal";
    if (c2.includes("file") || c2.includes("read")) return "FileText";
    if (c2.includes("code") || c2.includes("edit")) return "Code";
    if (c2.includes("media") || c2.includes("audio")) return "Volume2";
    if (c2.includes("screenshot")) return "Camera";
    if (c2.includes("reset")) return "RotateCcw";
    if (c2.includes("clear")) return "Trash2";
    return "Zap";
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      ref: containerRef,
      children: commands.map((cmd, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          onClick: () => onSelect(cmd.command),
          className: `flex items-center gap-3 px-4 py-2 cursor-pointer transition-colors ${index2 === selectedIndex ? "bg-white/10" : "hover:bg-white/5"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `p-1.5 rounded-lg ${index2 === selectedIndex ? "bg-white text-black" : "bg-bg-elevated text-text-muted"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: getIconForCommand(cmd.command), size: "sm" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-sm font-bold ${index2 === selectedIndex ? "text-white" : "text-text-primary"}`, children: cmd.command }),
              cmd.description && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-text-muted truncate", children: cmd.description })
            ] })
          ]
        },
        cmd.command
...
const PathPill = ({ path: path2 }) => {
  const fileName = path2.split(/[/\\]/).pop() || path2;
  const shortenedLabel = fileName.length > 20 ? `${fileName.substring(0, 17)}...` : fileName;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: path2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 border border-blue-200 dark:border-blue-800 cursor-default mx-0.5", children: shortenedLabel }) });
};
const Modal = ({ isOpen, onClose, title, children, footer: footer2 }) => {
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[100] flex items-center justify-center p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-4 border-b border-[var(--border-subtle)] bg-[var(--bg-elevated)]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-bold uppercase tracking-widest text-[var(--text-primary)]", children: title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: onClose,
                className: "p-1 rounded-md hover:bg-white/10 text-[var(--text-muted)] hover:text-white transition-colors",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "X", size: "md" })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 overflow-y-auto max-h-[70vh]", children }),
          footer2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-4 border-t border-[var(--border-subtle)] bg-black/20 flex justify-end gap-3", children: footer2 })
        ]
      }
    )
  ] }) });
...
const PromptModal = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen, onClose, title, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4 p-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-text-secondary", children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        autoFocus: true,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 pt-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "primary", onClick: handleSubmit, children: "Confirm" })
    ] })
  ] }) });
};
...
function ChatApp() {
  ...
  const [baseText, setBaseText] = reactExports.useState("");
  const [pathMap, setPathMap] = reactExports.useState({});
  const [attachments, setAttachments] = reactExports.useState([]);
  const [learnedBehaviors, setLearnedBehaviors] = reactExports.useState([]);
  const { startRecording, stopRecording, isRecording, isConnecting } = useVosk((text2, isPartial) => {
    if (isPartial) {
      setInputValue(baseText + (baseText ? " " : "") + text2 + "...");
    } else {
      const newBase = baseText + (baseText ? " " : "") + text2;
      setBaseText(newBase);
      setInputValue(newBase);
    }
  });
  const [isHistoryOpen, setIsHistoryOpen] = reactExports.useState(false);
  const [isWorkflowsOpen, setIsWorkflowsOpen] = reactExports.useState(false);
  const [isSettingsOpen, setIsSettingsOpen] = reactExports.useState(false);
  const [showSlashCommands, setShowSlashCommands] = reactExports.useState(false);
  const [selectedIndex, setSelectedIndex] = reactExports.useState(0);
  const [promptConfig, setPromptConfig] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    ...
    const unsubPrompt = window.chatAPI.onShowPromptRequest?.((event, data) => {
      setPromptConfig({
        isOpen: true,
  ...
  ].filter((c2) => c2.command.startsWith(inputValue.toLowerCase()));
  reactExports.useEffect(() => {
  ...
  const renderInputWithPills = () => {
    ...
    while ((match = regex.exec(inputValue)) !== null) {
      ...
      tokens.push(/* @__PURE__ */ jsxRuntimeExports.jsx(PathPill, { path: actualPath }, match.index));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      onDrop: handleDrop,
      children: [
        promptConfig && /* @__PURE__ */ jsxRuntimeExports.jsx(
          PromptModal,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-4 h-14 bg-bg-elevated border-b border-border-subtle shrink-0 select-none", style: { WebkitAppRegion: "drag" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", style: { WebkitAppRegion: "no-drag" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: "History", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsHistoryOpen(true), className: "p-2 rounded-md hover:bg-white/10 text-text-muted hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "History", size: "md" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: "Workflows", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsWorkflowsOpen(true), className: "p-2 rounded-md hover:bg-white/10 text-text-muted hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "GitBranch", size: "md" }) }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-bold uppercase tracking-wider text-text-secondary", children: selectedModel || "Gemini 2.5 Flash" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "ChevronDown", size: 12, className: "text-text-muted" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", style: { WebkitAppRegion: "no-drag" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: "Settings", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsSettingsOpen(true), className: "p-2 rounded-md hover:bg-white/10 text-text-muted hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "Settings", size: "md" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: isWakewordEnabled ? "Mute Wakeword" : "Enable Wakeword", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => toggleWakeword(!isWakewordEnabled), className: `p-2 rounded-md transition-colors ${isWakewordEnabled ? "text-text-primary" : "text-text-disabled hover:bg-white/5"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: isWakewordEnabled ? "Zap" : "ZapOff", size: "md" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => window.chatAPI.showWindow("lite"), className: "p-2 rounded-md hover:bg-white/10 text-text-muted hover:text-white transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "Minus", size: "md" }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollArea, { className: "flex-1 p-4 space-y-6", ref: scrollRef, children: [
          activeMessages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex flex-col ${msg.role === "user" ? "items-end" : "items-start"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `max-w-[90%] ${msg.role === "user" ? "bg-bg-elevated p-4 rounded-2xl rounded-tr-none border border-border-subtle" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Markdown,
            {
              ...
              components: {
                code({ node: node2, inline, className, children, ...props }) {
                  ...
                  return !inline ? /* @__PURE__ */ jsxRuntimeExports.jsx(CodeBlock, { code: String(children).replace(/\n$/, ""), language: match ? match[1] : "text" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-black/30 px-1 rounded text-sm", ...props, children });
                }
              },
              children: msg.content
            }
          ) }) }, msg.id)),
          mode === "act" && currentActions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-black uppercase tracking-widest text-text-muted mb-2", children: "Live Timeline" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: currentActions.map((action, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 text-text-secondary", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: action.status === "completed" ? "CheckCircle2" : action.status === "failed" ? "XCircle" : "Loader2", size: 14, className: action.status === "completed" ? "text-color-success" : action.status === "failed" ? "text-color-error" : "animate-spin" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-bold text-text-muted uppercase", children: action.tool }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs truncate", children: action.description })
                  ] }),
                  action.screenshot && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: action.screenshot, className: "w-8 h-6 rounded bg-black object-cover border border-white/5 opacity-40 group-hover:opacity-100 transition-opacity cursor-zoom-in" })
                ] }, i)) })
              ]
            }
          ),
          streamingContent && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start max-w-[90%]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { remarkPlugins: [remarkGfm], components: { p: ({ children }) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-4 last:mb-0 text-sm leading-relaxed inline", children }) }, children: streamingContent }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-1.5 h-4 ml-1 bg-white animate-pulse" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "p-4 space-y-4 bg-bg-base/80 backdrop-blur-md border-t border-border-subtle relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showSlashCommands && /* @__PURE__ */ jsxRuntimeExports.jsx(
            SlashCommandPopup,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex p-1 bg-bg-surface rounded-xl border border-border-subtle", children: ["ask", "act", "click"].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setMode(m), className: "relative flex-1 flex items-center justify-center gap-2 py-2 text-[10px] font-bold uppercase tracking-wider transition-colors z-10", children: [
            mode === m && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { layoutId: "mode-pill", className: "absolute inset-0 bg-white rounded-lg z-[-1]", transition: { type: "spring", bounce: 0.2, duration: 0.6 } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: m === "ask" ? "MessageSquare" : m === "act" ? "Zap" : "MousePointer", size: 14, className: mode === m ? "text-black" : "text-text-muted" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: mode === m ? "text-black" : "text-text-muted", children: m })
          ] }, m)) }),
          attachments.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto pb-2", children: attachments.map((att, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group shrink-0", children: [
            att.thumbnail ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: att.thumbnail, className: "w-12 h-12 rounded-lg object-cover border border-border-subtle" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-lg bg-bg-elevated flex items-center justify-center border border-border-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "File", size: "sm", className: "text-text-muted" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => setAttachments((prev) => prev.filter((_, idx) => idx !== i)),
                className: "absolute -top-1 -right-1 bg-red-500 text-white rounded-full p-0.5 opacity-0 group-hover:opacity-100 transition-opacity",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "X", size: 10 })
              }
            )
          ] }, i)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2 p-2 bg-bg-surface border border-border-default focus-within:border-border-strong rounded-2xl transition-colors relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleFileAttach, className: "p-2 rounded-lg hover:bg-white/5 text-text-muted hover:text-white transition-colors z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "Paperclip", size: "md" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 relative min-h-[40px]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: isRecording ? "Mic" : "MicOff", size: "md", className: isConnecting ? "animate-pulse" : "" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: isProcessing ? stopTask : handleSend, className: `p-2 rounded-xl transition-all ${isProcessing ? "bg-red-500 text-white" : "bg-white text-black hover:scale-105 active:scale-95"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: isProcessing ? "Square" : "ArrowUp", size: "md" }) })
          ] })
        ] })
      ]
    }
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChatApp, {}) })
);

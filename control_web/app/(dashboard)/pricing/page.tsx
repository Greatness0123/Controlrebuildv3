      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20 animate-in fade-in slide-in-from-bottom-5 duration-700">
          ...
          <p className="text-text-muted text-sm max-w-lg mx-auto leading-relaxed">
            Choose a plan that fits your execution needs. Upgrade anytime to unlock more cloud instances and higher session throughput.
          </p>
        </div>
          ...
          {plans.map((plan) => (
            <div 
              ...
              className={cn(
                ...
                plan.popular ? "bg-accent-primary text-accent-foreground border-accent-primary shadow-[0_0_50px_rgba(0,0,0,0.1)] scale-105 z-10" : "bg-card text-foreground border-border hover:border-border"
              )}
            >
              {plan.popular && (
              ...
              <div className="mb-8">
                ...
                <p className={cn("text-xs font-medium leading-relaxed", plan.popular ? "opacity-60" : "text-text-muted")}>
                  {plan.description}
                </p>
              </div>
              ...
              <div className="space-y-4 mb-10 flex-1">
                <div className="flex items-center gap-3">
                  <div className={cn("w-5 h-5 rounded-full flex items-center justify-center shrink-0", plan.popular ? "bg-accent-foreground/10" : "bg-card-hover")}>
        ...
        <div className="mt-32 p-10 bg-secondary/40 border border-border rounded-[40px] flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="max-w-md">
            <div className="flex items-center gap-3 text-emerald-500 mb-4">
              <Shield size={20} />
              <span className="text-[10px] font-black uppercase tracking-widest text-text-muted">Enterprise Security</span>
            </div>
          ...
          <button className="px-10 py-5 bg-card border border-border rounded-2xl text-[10px] font-black uppercase tracking-widest text-foreground hover:bg-card-hover transition-all">
